...
<div class="container" style="max-width: 1200px;">
	<div class="row">
		...
		if ( isset( $_POST[ 'submit' ] ) ) {
			...
			$sql = "INSERT INTO `studenttable` (`FName`, `LName`, `FaName`, `DOB`, `Addrs`, `Gender`, `PhNo`, `Eid`, `Pass`) VALUES ('$fname','$lname','$faname','$dob','$addrs','$gender','$phno','$email','$pass')";
    ...
    font-weight: bolder;
    text-align-last: center;"> Registration Form </h3>
					</legend>
