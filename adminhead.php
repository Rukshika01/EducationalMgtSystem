        ...
        <img src="img/Capture.JPG" alt="Edu Dive">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1" >
                <ul class="nav navbar-nav navbar-right" style="padding-top:40px;">
                        ...
                        <a href="welcomeadmin.php" style="color: #00d1cc;font-weight: bolder;padding-right:20px;">Home</a> 
                        <a href="logoutadmin" type="submit" style="color: #00d1cc;font-weight: bolder;padding-left:20px;">Logout</a>  
