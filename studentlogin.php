...
<div class="container">
    ...
    font-weight: bolder;
    text-align-last: center;"><span class="glyphicon glyphicon-lock"></span>&nbsp;  Student Login</h3>
				</legend>
				<form name="studentlogin" action="loginlinkstudent.php" method = "POST">
					...
					<button type="submit" name="login" class="btn btn-success" style="border-radius:0%">Login</button>
						...
						<br><br>
					<h5>Dont Have an Account? </h5>	 <a href="registrationform.php" style="color: #00d1cc;font-weight: bolder;padding-right:20px;padding-left:20px;">Sign up</a>
					</center>
			</fieldset>
			</form>
		</div>
