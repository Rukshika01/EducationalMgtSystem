	...
	<div class="row">
		...
		<div class="col-md-4">
			...
			<form action="" method="POST" name="update">
				...
				<div class="form-group">
					<label for="City">Subject Code : <span style="color: #ff0000;">*</span></label>
			...
			if ( isset( $_POST[ 'addnewfaculty' ] ) ) {
				...
				// adding new faculty
				$sql = "insert facutlytable (FName, FaName, Addrs, Gender, JDate, City, Pass, PhNo, sub_code) values ('$tempfname', '$tempfaname', '$tempaddrs','$tempgender', '$tempjdate', '$tempcity' , '$temppass','$tempphno',$tempsub_code)";
