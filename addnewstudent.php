...
<div class="container">
	...
	<div class="row">
		...
		if ( isset( $_POST[ 'addnews' ] ) ) {
			...
			$sql = "Insert into studenttable (FName, LName, FaName, DOB, Addrs, Gender, PhNo , Eid, Pass) values ('$tempfname', '$templname', '$tempfaname', '$tempdob', '$tempaddrs' , '$tempgender' , $tempphno, '$tempeid' , '$temppass')";
